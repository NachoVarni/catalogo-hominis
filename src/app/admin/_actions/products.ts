...
const supabase = createClient('https://hgkhgqlcllehbpxdardi.supabase.co', 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Imhna2hncWxjbGxlaGJweGRhcmRpIiwicm9sZSI6ImFub24iLCJpYXQiOjE3Mjc0NzA4MzQsImV4cCI6MjA0MzA0NjgzNH0.N_uxZLmTGQUlWEl1dPVJYNlLPQVy0Ve7hb1H6zSJ2Hg');
...
export async function addProduct(prevState: unknown, formData: FormData) {
  ...
  const uploadImage = async (file: File) => {
    ...
    return `https://hgkhgqlcllehbpxdardi.supabase.co/storage/v1/object/public/products/${filePath}`;
  };
